...
def cli():
    ...
    elif "xls" or "xlsx" in data_name:
        data= pd.read_excel(data_name)
    else:
        print("Warning: Upload csv or excel file")
    ...
    if winner == "KNN":
        ...
        model_func= "KNeighborsClassifier()"
    elif winner == "LR":
	...
	model_func= "GaussianNB()"
    	...
    	model_name= "Multilayer Perceptron (MLP) Classifier"
	library= "from sklearn.neural_network import MLPClassifier"
	model_func= "MLPClassifier()"
    elif winner == "SGD":
    	model_name= "Stochastic Gradient Descent Classifier"
	library= "from sklearn.linear_model import SGDClassifier"
	model_func= "SGDClassifier()"
    elif winner == "ADA":
    	model_name= "AdaBoost Classifier"
	library= "from sklearn.ensemble import AdaBoostClassifier"
	model_func= "AdaBoostClassifier()"
    elif winner == "BAG":
    	model_name= "Bagging Classifier"
	library= "from sklearn.ensemble import BaggingClassifier"
	model_func= "BaggingClassifier()"

    print( '\033[1m'+ '\033[92m' +  "Recommended Algorithm:", model_name, "\n",'\033[0m'+ '\033[1m'+"Import this algorithm:", "\n", '\033[0m'+ library,"\n","model= ",model_func)
